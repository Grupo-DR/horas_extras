...
export const OpportunityCard: React.FC<OpportunityCardProps> = ({
    ...
    const internalOwner = users.find(u => u.id === opportunity.ownerId) || null;
        ...
        >
            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center text-xs text-slate-500">
                    ...
                    <span className="truncate max-w-[150px]" title={opportunity.contactName || 'N/A'}>
                        {opportunity.contactName || 'Contato N/A'}
                    </span>
                </div>
                ...
                <div className="flex justify-between items-center pt-2 border-t border-slate-100">
                    <div className={`flex items-center text-xs ${isOverdue ? 'text-red-500 font-bold' : 'text-slate-400'}`}>
                        ...
                        <span>{format(opportunity.deadline, "dd MMM", { locale: ptBR })}</span>
                    </div>
