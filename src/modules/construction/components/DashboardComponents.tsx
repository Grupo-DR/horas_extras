                ...
                <div className="bg-slate-50 p-4 rounded-xl mb-6">
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-black text-indigo-600">{formatCurrencyWithZero(category.actual)}</p>
                        </div>
                        <div>
                            <p className="text-[10px] font-bold text-slate-400 uppercase">Diferença</p>
                            <p className={`text-lg font-black ${(category.actual - (category.planned || 0)) >= 0 ? 'text-emerald-600' : 'text-red-600'}`}>
                                {(category.actual - (category.planned || 0)) >= 0 ? '+' : ''}{formatCurrencyWithZero(category.actual - (category.planned || 0))}
                            </p>
                        </div>
                    </div>
                </div>
