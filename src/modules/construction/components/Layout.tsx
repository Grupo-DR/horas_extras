...
import { 
  ...
  Coins, CalendarRange, Download, Trash2, Cloud
} from 'lucide-react';
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col shrink-0">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
            ...
            <>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                  activeView === 'dashboard' ? 'bg-amber-500 text-slate-900 font-semibold' : 'hover:bg-slate-800 text-slate-400'
                }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                  activeView === 'planning' ? 'bg-amber-500 text-slate-900 font-semibold' : 'hover:bg-slate-800 text-slate-400'
                }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                  activeView === 'table' ? 'bg-amber-500 text-slate-900 font-semibold' : 'hover:bg-slate-800 text-slate-400'
                }`}
              >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
              activeView === 'services' ? 'bg-amber-500 text-slate-900 font-semibold' : 'hover:bg-slate-800 text-slate-400'
            }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
              activeView === 'upload' ? 'bg-amber-500 text-slate-900 font-semibold' : 'hover:bg-slate-800 text-slate-400'
            }`}
          >
